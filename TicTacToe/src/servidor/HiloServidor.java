...
public class HiloServidor implements Runnable {
    ...
    public boolean gano(int n) {
        return ((G[0][0] == n && G[0][1] == n && G[0][2] == n) || (G[1][0] == n && G[1][1] == n && G[1][2] == n) || (G[2][0] == n && G[2][1] == n && G[2][2] == n) || (G[0][0] == n && G[1][0] == n && G[2][0] == n) || (G[0][1] == n && G[1][1] == n && G[2][1] == n) || (G[0][2] == n && G[1][2] == n && G[2][2] == n) || (G[0][0] == n && G[1][1] == n && G[2][2] == n) || (G[0][2] == n && G[1][1] == n && G[2][0] == n));
